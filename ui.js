...
export function renderLogin() {
  const te = getTE();
  $("cc").innerHTML = `<div class="section-title">Entrar no Bolão</div><div style="max-width:410px" id="aw"><div id="af"><div class="card"><div id="aa"></div><div class="form-group"><label>E-mail</label><input id="le" type="email" placeholder="seu@email.com"></div><div class="form-group"><label>Senha</label><input id="lp" type="password" placeholder="••••••"></div><button class="btn" style="width:100%" onclick="doLogin()">Entrar 🚀</button><div style="text-align:center;margin-top:11px"><a onclick="doReset()" style="color:var(--muted);font-size:.73rem;cursor:pointer;text-decoration:underline">Esqueci minha senha</a></div></div><div class="auth-toggle">Não tem conta? <a onclick="showReg()">Criar agora</a></div></div></div>`;
